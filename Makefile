...
.DEFAULT_GOAL := help
.PHONY: help build build-linux test vet check docs docs-check licenses licenses-check bench fuzz demo toolchain generate integration docker up down status clean
help:
