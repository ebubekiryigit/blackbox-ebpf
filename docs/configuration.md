...
The initial configuration format has no public version or migration history yet.
YAML validation rejects unknown and duplicate keys, multiple documents, malformed
